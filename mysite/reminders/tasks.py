...
def send_sms_reminder(self):
    ...
    reminder_time = arrow.get(self.reminder.time, self.reminder.time_zone.zone)
    body = 'Hi {0}. You have a reminder coming up at {1}.'.format(self.reminder.name,
     self.reminder_time.format('h:mm a'))
 
    message = client.messages.create(
        
        body=body,
        to=self.reminder.phone_number,
